...
const tiers = [
  { tier: "Platinum", color: "text-gold", border: "border-gold/40", names: ["RoboCorp", "NimbusAI"] },
  { tier: "Gold", color: "text-cyan", border: "border-cyan/40", names: ["IIT Bombay", "Indian BIT", "NIT Delhi"] },
  { tier: "Silver", color: "text-muted-foreground", border: "border-hairline", names: ["NIT Silchar", "Robo Company", "MotorWorks", "VoltLabs"] },
  { tier: "Community", color: "text-accent", border: "border-accent/40", names: ["MakerHub", "BotForge", "GearStack", "OpenArena", "Solder.io"] },
];
    ...
    <PageShell>
      ...
      <Section>
          ...
          <div key={t.tier} className={i ? "mt-14" : ""}>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
              {t.names.map((n, j) => (
                ...
                >
                  <motion.div animate={{ rotate: [0, 8, 0, -8, 0] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: j * 0.2 }}>
        ...
        >
          ...
          <button className="mt-6 rounded-md bg-accent px-6 py-3 text-xs font-bold tracking-wider text-accent-foreground transition hover:brightness-110">
