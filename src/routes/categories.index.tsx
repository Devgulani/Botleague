...
export const CATEGORIES = [
  {
    ...
    rules: [
      "Teams of 2–4 builders",
      "Pre-built kits allowed",
      "30-minute timed runs",
    ],
  },
  {
            ...
            >
              <div className="aspect-[5/3] overflow-hidden rounded-xl bg-gradient-to-br from-accent/20 via-surface-2 to-cyan/10">
                <div className="flex h-full items-center justify-center">
                  <c.icon className="h-14 w-14 text-gold transition-transform duration-500 group-hover:scale-110" strokeWidth={1.2} />
                </div>
              </div>
