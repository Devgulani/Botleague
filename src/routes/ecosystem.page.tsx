...
const groups = [
  {
    icon: GraduationCap,
    title: "Students",
    desc: "Compete, learn, and build your robotics portfolio.",
    cta: "Join as Student",
  },
  {
    icon: UserCog,
    title: "Mentors",
    desc: "Coach the next generation of engineers.",
    cta: "Become a Mentor",
  },
  {
    icon: Landmark,
    title: "Colleges",
    desc: "Host regional events and earn institutional badges.",
    cta: "Partner College",
  },
  {
    icon: Building2,
    title: "Companies",
    desc: "Recruit verified talent from the arena.",
    cta: "Hire Talent",
  },
  {
    icon: Rocket,
    title: "Startups",
    desc: "Source hardware founders and prototype teams.",
    cta: "Connect Now",
  },
  {
    icon: Users,
    title: "Communities",
    desc: "Bring your maker collective into the league.",
    cta: "Affiliate Us",
  },
];
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {groups.map((g, i) => (
            <motion.div
              ...
              className="group rounded-2xl border border-hairline bg-surface-1 p-6 transition hover:border-accent/40 hover:shadow-[0_24px_60px_-24px_rgba(255,45,45,0.35)]"
            >
